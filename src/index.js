...
async function initDB(env) {
  ...
  await DB.exec('CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT,username TEXT UNIQUE NOT NULL,password_hash TEXT NOT NULL,name TEXT NOT NULL,role TEXT NOT NULL DEFAULT \'user\',permitted_depts TEXT DEFAULT \'[]\',permitted_subdepts TEXT DEFAULT \'[]\',created_at TEXT DEFAULT (datetime(\'now\')))');
